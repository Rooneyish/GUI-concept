...
public class lecturer extends teacher{
    ...
    String workingType, String employmentStatus, String department, int yearsOfExperience,int workingHours,int gradedScore){
    ...
    public String gradeAssignment(int gradedScore, String department, int yearsOfExperience){
        if(hasGraded==false)//to ensure that the assignment is not graded{
            if(yearsOfExperience>=5 && this.department.equals(department))/*to ensure the lecturer's 
